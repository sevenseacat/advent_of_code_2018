defmodule Day9 do
  ...
  @doc """
  iex> Day9.place_marble([0], 1, 0)
  {0, 1, [0, 1]}

  iex> Day9.place_marble([0, 1], 2, 1)
  {0, 1, [0, 2, 1]}

  iex> Day9.place_marble([0, 2, 1], 3, 1)
  {0, 3, [0, 2, 1, 3]}

  iex> Day9.place_marble([0, 16, 8, 17, 4, 18, 9, 19, 2, 20, 10, 21, 5, 22, 11, 1, 12, 6, 13, 3, 14, 7, 15],
  ...> 23, 13)
  ...
  def bench do
    Benchee.run(
      %{
        ...
        # "day 9, part 2" => fn -> part2("429 players; last marble is worth 7090100 points") end
      },
